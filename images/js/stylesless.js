...
$( "#imgrobo1, #imgrobo2, #imgrobo3, #robotwaving, #coffeeofthemonth" ).mouseover(function(){
  $( this ).addClass( "robo_styles" );
    $( this ).find( "span" ).text( "Hello" );
  });
$( "#imgrobo1, #imgrobo2, #imgrobo3, #robotwaving, #coffeeofthemonth" ).mouseout(function(){
  $( this ).addClass( "robo_styles" );
